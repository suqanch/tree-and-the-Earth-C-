...
//~ class. The function takes three parameters: the light's position, the view vector and
//~ the point of intersection where the colour value needs to be computed.
